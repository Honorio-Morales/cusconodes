...
\begin{center}
\small\url{https://github.com/Honorio-Morales/cusconodes}
\end{center}

La aplicacion desplegada esta disponible en:
\begin{center}
\small\url{https://cusconodes.onrender.com}
\end{center}
...
La Figura~1 muestra la arquitectura de despliegue del sistema.
